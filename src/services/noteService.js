...
export function getAllTypesService() {
    return getRequest(`/note/getAllTypes`);
}

export function getAllTagsService() {
    return getRequest(`/note/getAllTags`);
}

export function queryNoteService(params) {
    return postRequest('/note/query', params)
}